      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center space-x-6 mt-3 text-sm">
            <span>
              <strong className="text-white">{profile.post_count || posts.length}</strong> Posts
            </span>
            <button
              onClick={() => handleTabChange('followers')}
              className={`hover:text-red-400 transition ${
                activeTab === 'followers' ? 'text-red-500' : 'text-gray-400'
              }`}
            >
            ...
            <button
              ...
              className={`hover:text-red-400 transition ${
                activeTab === 'following' ? 'text-red-500' : 'text-gray-400'
              }`}
            >
